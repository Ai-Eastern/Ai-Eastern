...
AI agent developer focused on reliable workflows, retrieval systems, backend observability, and developer tooling.
...
[![ECC PR #3184 merged](https://img.shields.io/badge/ECC-PR%20%233184%20merged-2EA44F?style=flat&logo=github&logoColor=white&labelColor=181717)](https://github.com/affaan-m/ECC/pull/3184)
...
- [enterprise-service-desk-agent-history](https://github.com/Ai-Eastern/enterprise-service-desk-agent-history) — A four-stage history of an enterprise service desk agent: RAG → MCP → A2A → multi-agent.
...
- Small, testable open-source contributions
